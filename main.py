...
folium.Marker( location=[30.339309 ,-97.746972], popup = folium.Popup(
...
folium.Marker( location=[30.3252 ,-97.743248], popup = folium.Popup(
...
folium.Marker( location=[30.336331988, -97.718163794], popup = folium.Popup(
